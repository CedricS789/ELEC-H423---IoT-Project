...
We implemented an application-layer security protocol that ensures data privacy and integrity before it even reaches the network stack.
\begin{figure}[H]
    \centering
...
This payload is then encrypted using AES-128. For each message, 
