...
The project implements a secure remote monitoring system for temperature and humidity, using two ESP32 microcontrollers communicating over MQTT. 
...
It receives the encrypted data, authenticates the source, decrypts the payload, and displays the information via a local web server and a visualization dashboard.
...
For key agreement, we use a manual entry method, namely Morse code, to derive session keys, 
