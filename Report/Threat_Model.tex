...
STRIDE model derive from an acronym for the following six threat categories: \textbf{Spoofing}, the illegal use of another user authentication information. \textbf{Tampering}, a maliciously modified data. \textbf{Repudiation}, users refuse to engage in activities, and there is no way to prove it was repudiation. \textbf{Information Disclosure}, The unintended exposure of confidential or sensitive information to unauthorized parties. \textbf{Denials of Service}, attacks that disrupt the availability of services, making the system unusable for legitimate users. \textbf{Elevation of Privilege},An attacker gains a higher level of access or more capabilities than intended, often by exploiting a vulnerability.


\textbf{Take back the STRIDE model used in the security powerpoint and explain each category}

\begin{enumerate}
    \item Spoofing
    \item Tampering
    \item Repudation
    \item Info Disclosure
    \item Denials of service
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../pic/STRIDE.PNG}
